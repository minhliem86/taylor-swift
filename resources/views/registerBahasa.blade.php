						...
						<div class="col-md-7 col-sm-12 col-full">
							<div class="wrap-left">
								<div class="table-cell">
									<div class="box">
										<h2 class="title">Bermitra dengan Parfarome</h2>
										<p class="sub-box">Anda siap Bergabung dengan kami perusahaan parfum multinasional Eropa yang siap menyediakan bibit Parfum ritel yang bebas dari bahan-bahan yang dilarang oleh hukum Islam. Bagaimana cara bermitra dengan kami?</p>
									</div>
									<div class="box">
										<h2 class="title title-img pupple retailer">Pengecer</h2>
										<p class="sub-box pupple">Anda bisa memiliki sebuah toko Parfarome dari bibit parfum ritel berkualitas tinggi dengan harga yang sangat kompetitif.</p>
									</div>

									<div class="box">
										<h2 class="title title-img Entrep">Wiraswasta</h2>
										<p class="sub-box ">Parfarome membuka bisnis waralaba di seluruh Indonesia. Jadilah bagian dari 50 + titik distribusi di seluruh Negeri.</p>
									</div>

									<div class="box">
										<h2 class="title title-img pupple sale">Agen penjualan</h2>
										<p class="sub-box pupple">Apakah Anda seorang agen terbaik? Di sini Anda memiliki produk yang baik, harga yang sempurna, dan kualitas utama Eropa dengan biaya yang sangat kompetitif.</p>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-5 col-sm-12 col-full">
							<div class="wrap-right">
								<div class="wrap-form">
									...
									@endif
									{!!Form::open(array('route'=>'register-bahasa-version-post','class'=>'form-register','id'=>'formRegister'))!!}
										...
										<div class="form-group">
											{!!Form::select('province',array_merge(array(''=>'Pilih Propinsi...'),$province),old('province'),array('class'=>'form-control') )!!}
										</div>
										<div class="form-group">
											<input type="text" name="phone" class="form-control" placeholder="Phone..." value="{!!old('phone')!!}">
										</div>
										<div class="form-group">
											{!!Form::select('profile',array_merge(array(''=>'Pilih Profil...'),$profile),old('profile'),array('class'=>'form-control'))!!}
										</div>
										<div class="form-group">
											<textarea name="feedback" rows="3" class="form-control" placeholder="Komentar..." value="{!!old('feedback')!!}"></textarea>
										</div>
